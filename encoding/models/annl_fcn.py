...
class annl_fcn(BaseNet):
    ...
    Examples
    --------
    >>> model = annl_fcn(nclass=21, backbone='resnet50')
    >>> print(model)
    """
...
class annl_fcnHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer):
        ...
        self.pam0 = APAM_Module(in_dim=inter_channels, key_dim=inter_channels//8,value_dim=inter_channels,out_dim=inter_channels,norm_layer=norm_layer)
